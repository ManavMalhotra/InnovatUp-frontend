    ...
    >
      ...
      <div className="relative z-10 max-w-6xl px-4 mx-auto sm:px-6 lg:px-8">
        ...
        <div ref={poolRef} className="mb-20 text-center relative max-w-max mx-auto">
          ...
          <div className="relative inline-block py-4 px-4 sm:py-6 sm:px-12 glass-card-hover rounded-[2rem] sm:rounded-[3rem] border-primary/20 bg-background/40 backdrop-blur-md">
            <p className="text-4xl min-[400px]:text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-black leading-none tracking-tighter font-display text-transparent bg-clip-text bg-gradient-to-br from-white via-blue-100 to-primary drop-shadow-2xl">
              {totalPrizePool}
              <span className="text-primary inline-block transform translate-y-0 sm:translate-y-2 lg:translate-y-4">+</span>
            </p>
